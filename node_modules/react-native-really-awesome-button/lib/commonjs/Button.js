...
const AwesomeButton = _ref => {
  ...
  const debouncedPress = (0, _react.useRef)(debouncedPressTime ? (0, _lodash.default)(animateProgressEnd => onPress(animateProgressEnd), debouncedPressTime, {
    trailing: false,
    leading: true
  }) : onPress);
  const layout = {
  ...
  }, extra, /*#__PURE__*/_react.default.createElement(_reactNative.Animated.View, {
